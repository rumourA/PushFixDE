...
void SetupPatches(GameData gd)
{
    ...
    int m_vecBaseVelocity_flag = gEngineVersion == Engine_CSGO ? 0 : 4;
    ...
    ASSERT_MSG(LoadFromAddress(m_vecBaseVelocity_flags, NumberType_Int32) == m_vecBaseVelocity_flag, "Invalid or outdated \"m_vecBaseVelocity\" + offset address.");
